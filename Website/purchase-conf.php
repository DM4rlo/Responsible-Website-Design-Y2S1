        ...
        <div class="container">
            <div class="welcome-bg">
                <div class="welcome-tile">
                    ...
                    <p id="qaz">Your purchase request will stay pending in our database for up to 3 working days, if the instruction
                        sent to your email haven't been followed to proceed with the payment your request will be canceled.
                    </p>
                </div>
            </div>
        </div>
