        ...
        <div class="container">
            <div class="welcome-bg">
                <div class="welcome-tile">
                    ...
                    <p>Now your logged in as a customer you now have access to features that enable you to book events we host, in addition to
                        making updates to your account with us. With the my account page you will be able to read, update and even terminate your account 
                        with us if you no longer want to use our services. 
                    </p>
                </div>
            </div>
        </div>
