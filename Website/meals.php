...
<body>
    ...
    <section>
        ...
        <div class="container">
            <div class="sub-box">
                <div class="sub-title">Browse through assortment of Meals</div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="sub-bg">
                <p id="para_contact">This page catalogues some of our meals we provide in store all <br>year round, you are able to find information on the name, price <br>
                    and a brief description in addtion to if the meal is vegan friendly or not.</p>
            </div>
        </div>
        ...
        <div class="cards-bg">
            <div class="cards">
                ...
                <?php
                     ...
                     // Query Database (For Food Items)
                     $sql = "SELECT * FROM menu WHERE typ = 'food'";
