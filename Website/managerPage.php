        ...
        <div class="container">
            <div class="welcome-bg">
                <div class="welcome-tile">
                    ...
                    <p>Now your logged in as a Manager you now have access to features that enable you to
                        make updates to your account with us. With the Employee page you will be able to read and create employee accounts as managers
                        are responsible for managing the company's employees.
                    </p>
                </div>
            </div>
        </div>
